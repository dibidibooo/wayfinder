...
import {Vector3, PathPointList} from "three";
...
var Path3D = function() {
	...
	this._lastPoint = new Vector3();
	this._lastFixedPoint = new Vector3();
	...
	this.up = new Vector3(0, 1, 0); // force up
}
